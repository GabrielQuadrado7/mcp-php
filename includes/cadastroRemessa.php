...
if(count($return) == 1)
{
    $btn = '<button class="btn text-muted" id="botao-favotirar" title="adicionar página aos favoritos" onclick="deletarFavorito(`Cadastro Remessa`, `/cadastroRemessa`)">
                <img src="../../assets/star.svg" id="favorito-star">
            </button>';
}
else
{
    $btn = "<btn class='btn text-muted' id='botao-favotirar' title='adicionar página aos favoritos' onclick='cadastrarFavorito(`Cadastro Remessa`, `/cadastroRemessa`)'>
